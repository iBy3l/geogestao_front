...
class MapsModule extends Module {
  ...
  void exportedBinds(Injector i) {
    i.addLazySingleton<MapboxGeocodingDatasource>(
      MapboxGeocodingDatasourceImpl.new,
    );
    ...
    i.addLazySingleton<CepAddressUsecase>(CepAddressUsecase.new);
    i.addLazySingleton(MapController.new);
    i.addLazySingleton<CepController>(CepController.new);
  }
}
